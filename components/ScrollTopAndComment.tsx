    ...
    >
      {siteMetadata.comments?.provider && (
        <button
          ...
          className="hidden rounded-full bg-gray-200 p-2 text-gray-500 transition-all hover:bg-gray-300 md:block dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600"
        >
