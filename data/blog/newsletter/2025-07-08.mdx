...
This nudges WorkOS closer to becoming a comprehensive product platform, in direct competiton to LaunchDarkly and Statsig.`

The WorkOS homepage is still focused on features like "single sign-on", so the company hasn't full repositioned itself yet. My guess is that product analytics or experiments is coming next.
...
The launch also cleared up why CEO Sam Lambert had a Twitter feud with his now direct competitor, Neon, ([see my coverage](/blog/newsletter/2025-06-23#enterprise-watch-)) and praised his launch partner Conex. When Lambert [sparred with Neon's CEO](https://x.com/isamlambert/status/1935333197635588393) about database reliability PlanetScale was already building their Postgres competitor.
