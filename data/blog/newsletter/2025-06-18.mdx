...
Lakebase is unique because developers can use it for operational data and analytical workloads. [Suddenly the massive Neon acquisition makes sense](/blog/newsletter/2025-05-20). Lakebase is built on Neon and has the branching and “serverless” features that made Neon popular.
...
**Stripe**, the payments platform, acquired **Privy**, the crypto wallet infrastructure company. Wait - [crypto is still a thing](https://coinpedia.org/news/why-are-bitcoin-and-altcoins-down-today-heres-why/)?
...
- [Blog post](https://privy.io/blog/announcing-our-acquisition-by-stripe)
...
- [Blog post](https://www.cursor.com/blog/series-c)
