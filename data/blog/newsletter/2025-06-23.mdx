...
Their thesis is compelling:

> "It's never been easier to build software... It's never been easier to ship and scale software. But, it's never been harder to monetize software."

Polar is betting that the next wave of unicorns will be built by individual developers who need sophisticated billing without the complexity.
